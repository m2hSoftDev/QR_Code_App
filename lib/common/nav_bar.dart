...
Widget buildBottomNavigation(BuildContext context) {
  return Container(
    ...
    child: Row(
      ...
      children: [
        buildNavItem(
            context, Icons.qr_code_scanner, ' Scan QR', HomePage.route),
...
Widget buildNavItem(
  ...
  return InkWell(
    onTap: () {
      ...
      if (route == '/settings') {
        Navigator.pushNamed(context, route); // Use push only for settings
      } else {
        Navigator.pushReplacementNamed(context, route); // Replace for others
      }
    },
    child: Column(
